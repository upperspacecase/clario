...
import { WORKFLOWS, questionsFor, type WorkflowDef } from "@/lib/taxonomy";
                    ...
                    <div key={q.id}>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <input
                          ...
                          onChange={(e) => update("timeMax", e.target.value)}
                          placeholder="To"
                          className="h-11 w-24 rounded-xl border border-[#0B3049]/12 bg-white px-3 text-[15px] focus:border-[#16a34a] focus:outline-none disabled:opacity-40"
                        />
                      ...
                      <label className="mt-2 flex items-center gap-2 text-[13px] text-[#476582]">
                        <input
                          type="checkbox"
                          checked={notSure}
                          onChange={(e) => update("timeNotSure", e.target.checked)}
